...
import (
	...
	{% if cookiecutter.logger_type == "logrus" %}"github.com/sirupsen/logrus"{% endif %}
	{% if cookiecutter.logger_type == "zap" %}"go.uber.org/zap"{% endif %}
	{% if cookiecutter.use_viper_config == "y" %}"github.com/{{cookiecutter.github_username}}/{{cookiecutter.project_slug}}/config"{% endif %}
)

{% if cookiecutter.logger_type == "logrus" %}
